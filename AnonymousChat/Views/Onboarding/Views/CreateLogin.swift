                ...
                VStack {
                    ...
                    Button(action: {
                        Task {
                            ...
                            await userViewModel.createNewAccount(email: email, password: password) {
                    ...
                    NavigationLink(destination: ProfilePicker(userViewModel: userViewModel), isActive: $shouldNavigate) {
                        EmptyView()
                    }
                    
//                    NavigationLink(destination: ProfilePicker(userViewModel: userViewModel)) {
//                        ZStack {
//                            Rectangle()
